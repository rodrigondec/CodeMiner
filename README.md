...
Project made in Ruby for Codeminer
...
### Running
run the files `task1.rb`, `task2.rb` and `task_plus.rb` with the command `ruby`. If there's make support on your OS you may use `make task.1` or `make task.2` or `make task.plus`.
...
###### example
![hash players example](relative/path/to/img.jpg?raw=true "Hash Players Example")
##### kills
...
###### example
![game info example](relative/path/to/img.jpg?raw=true "Game Info Example")
